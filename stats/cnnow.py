...
# coding=utf-8
#
# exploration of DNS names using "cnnow" as name servers.
# start with the million file.
# extract the list of names that end with ".cn"
#  - consider printing a count by category, 1-100, etc.
#  - or maybe just use  single list
import sys
import dns.resolver
import json
import traceback
...
def main():
    ...
    if len(sys.argv) != 7 and len(sys.argv) != 8:
        print("Usage: " + sys.argv[0] + " nb_trials ip2as.csv ip2as6.csv publicsuffix.dat domain_list result_file [tmp_prefix]")
        exit(1)
...
if __name__ == '__main__':
    main()
# resolve the corresponding names
# print the list of hosters
#
